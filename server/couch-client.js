...
function CouchClient(url) {
  ...
  function changes(opts, callback) {
	opts = Object.prototype.toString.call(opts) == "[object Object]" ? opts : { since: opts || 0 };
    var stream = request("GET", uri.pathname + "/_changes?filter="+(opts.filter||"")+"&feed=continuous&heartbeat=1000&since=" + opts.since);
    var data = "";
    function checkData() {
      var p = data.indexOf("\n");
      if (p >= 0) {
